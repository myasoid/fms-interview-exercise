...
import com.fms.interview_exercise.web.rest.vm.ManagedUserVM;
...
public class UserResource {
     ...
     * <p>
     * Creates a new user if the login is not already used.
     * </p>
     *
     * @param managedUserVM the user to create
     * @return the ResponseEntity with status 201 (Created) and with body the new user, or with status 400 (Bad Request) if the login is already in use
    ...
    public ResponseEntity<UserDTO> updateUser(@RequestBody ManagedUserVM managedUserVM) {
        ...
        Optional<User> existingUser = userService.findOneByLogin(managedUserVM.getLogin().toLowerCase());
